...
namespace Smart_FTY
{
    public partial class FORM_SMT_ROLL_LEADTIME_MONTH : Form
    {
        public FORM_SMT_ROLL_LEADTIME_MONTH()
        {
            InitializeComponent();
        ...
        public static string _sProcess = "EVA";
        public int iCount = 0;
        ...
        {
            Form fc = Application.OpenForms["FRM_ROLL_LEADTIME"];
            if (fc != null)
            {
            ...
            {
                FRM_ROLL_LEADTIME f = new FRM_ROLL_LEADTIME();
                f.Show();
                this.Hide();
            }
        }

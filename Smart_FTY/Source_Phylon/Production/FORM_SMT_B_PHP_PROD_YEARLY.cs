...
namespace Smart_FTY
{
    public partial class FORM_SMT_B_PHP_PROD_YEARLY : SampleFrm2
    {
        public FORM_SMT_B_PHP_PROD_YEARLY()
        {
            InitializeComponent();
            //formName = "FORM_SMT_B_PHP_PROD_YEARLY";
            this.Name = "FORM_SMT_B_PHP_PROD_YEARLY";
            this.Text = "FORM_SMT_B_PHP_PROD_YEARLY";
        }
        ...
        public DataTable SMT_B_PHP_PRODUCTION_YEARLY(string V_P_YEAR, string V_P_PROCESS)
        {
            COM.OraDB MyOraDB = new COM.OraDB();
            DataSet ds_ret;
            try
            {
                string process_name = "MES.PKG_SMT_B_PRODUCTION.SMT_B_PHP_PRODUCTION_YEARLY";
        ...
        private void Search_Data()
        {
            ...
            DataTable dt = SMT_B_PHP_PRODUCTION_YEARLY(sDate, _sProcess);
        ...
        private void lblEVA_Click(object sender, EventArgs e)
        {
            ...
            lblTitle.Text = "Phylon Production Status by Year";
            _sProcess = "PHP";
        ...
        private void FORM_SMT_B_PHP_PROD_YEARLY_VisibleChanged(object sender, EventArgs e)
        {
            if (this.Visible)
            {
                iCount = 39;

...
namespace Smart_FTY
{
    public partial class FORM_SMT_PH_PROD_YEAR : SampleFrm2
    {
        public FORM_SMT_PH_PROD_YEAR()
        {
            InitializeComponent();
            lblTitle.Text = "CMP Production Status by Year";
           // formName = "FORM_SMT_PH_PROD_YEAR";
            this.Name = "FORM_SMT_PH_PROD_YEAR";
            this.Text = "FORM_SMT_PH_PROD_YEAR";
        }

        public static string _sProcess = "CMP";
        public int iCount = 0;
        string APS_YN = "N";
        private void FORM_SMT_PH_PROD_YEAR_Load(object sender, EventArgs e)
        {
        ...
        private void BindingData(string arg_op)
        {
            ...
            dtsource = SEL_OS_PROD_YEAR("Q",APS_YN, uc_year.GetValue().ToString(), arg_op);
        ...
        {
            DataTable dt = null;
            dt = SEL_OS_PROD_YEAR("C",APS_YN, uc_year.GetValue().ToString(), arg_op);
        ...
        private void lblEVA_Click(object sender, EventArgs e)
        {
            ...
            if (APS_YN.Equals("N"))
            lblTitle.Text = "Phylon Pcard Production Status by Year";
            else
                lblTitle.Text = "Phylon APS Production Status by Year";
            _sProcess = "PHP";
        ...
        private void lblRubber_Click(object sender, EventArgs e)
        {
            ...
            if (APS_YN.Equals("N"))
                lblTitle.Text = "CMP Pcard Production Status by Year";
            else
                lblTitle.Text = "CMP APS Production Status by Year";
            _sProcess = "CMP";
        ...
        private void FORM_SMT_PH_PROD_YEAR_VisibleChanged(object sender, EventArgs e)
        {
        ...
        private void gvwView_RowCellStyle_1(object sender, DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs e)
        {
            if (e.Column.ColumnHandle == 1)
            {
                e.Appearance.BackColor = Color.LightGray;//Color.FromArgb(80, 209, 244);
            ...
            try
            {
                ...
                if (((DevExpress.XtraEditors.SimpleButton)sender).Tag.ToString().Equals("0"))
                {
                    ...
                    if (!_sProcess.Equals("CMP"))
                        ...
                        lblTitle.Text = _sProcess + " - APS Production status by Year";
                }
                else
                {
                    ((DevExpress.XtraEditors.SimpleButton)sender).Enabled = false;
                    ...
                    if (!_sProcess.Equals("CMP"))
                        ...
                        lblTitle.Text = _sProcess + " - Pcard Production status by Year";
                }
                iCount = 0;
                BindingData(_sProcess);
                bindingdatachart(_sProcess);

...
namespace Smart_FTY
{
    public partial class FRM_SMT_PH_TOPO_WEEKLY : Form
    {
        public FRM_SMT_PH_TOPO_WEEKLY()
        {
            InitializeComponent();
        }
            ...
            switch (ButtonCD)
            {
                ...
                case "D":
                    ...
                    else
                    {
                        ...
                        Form_Home_Phylon._frmTOPO.Show(); 
                    }
                    break;
                case "W":
                    this.Hide();
                    Form fc1 = Application.OpenForms["FRM_SMT_PH_TOPO_WEEKLY"];
                    if (fc1 != null)
                        fc1.Show();
                    else
                    {
        ...
        private void BindingData(string arg_op)
        {
            try
            {
                ...
                dtsource = SEL_OS_TOPO_WEEKLY("Q", arg_op);
        ...
        private void gvwView_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (view != null)
            {
                ...
                if (hitInfo.RowHandle < 0)
                {
                    ...
                    {
                        FRM_SMT_PH_TOPO_DAILY f1 = new FRM_SMT_PH_TOPO_DAILY("FORM");
                        f1.Show();
                    }
                }
            }

...
namespace FlexQuality.ClassLib
{
    ...
    public class ComFunction : COM.ComFunction
    {
        ...
        /// <summary>
        /// Set_ComboList1_5 : 5개짜리 콤보리스트 -> 채산에서 스타일 콤보 세팅
        /// </summary> 
        public static void Set_ComboList1_5(DataTable dtcmb_list, C1.Win.C1List.C1Combo arg_cmb,
        ...
        public static void CreateComboBox(C1.Win.C1List.C1Combo arg_cmb, string[] code, string[] name)
        {
            ...
            {
                MessageBox.Show(ex.Message.ToString(), "Set_ComboList1_AddItem", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public static string Set_RD_Directory(string arg_FormName)
        {
            ...
            //return "C:\\Sephiroth\\FlexQuality\\Report\\" + arg_FormName + ".mrd";

            return Application.StartupPath + "\\Report\\Quality\\" + arg_FormName + ".mrd";

            //			return "K:\\Sephiroth_QCS\\Sephiroth\\QUALITY\\Report\\Quality\\" + arg_FormName + ".mrd";
        }
        ...
        {/*
            ...
            FlexQuality.ClassLib.ComVar.DivGen = ret.Tables[strGenPst].Rows[0].ItemArray[0].ToString();



            FlexQuality.ClassLib.ComVar.DivPst = ret.Tables[strGenPst].Rows[0].ItemArray[1].ToString();
            FlexQuality.ClassLib.ComVar.DivStyleNm = ret.Tables[strGenPst].Rows[0].ItemArray[2].ToString();
		...
		*/
        ...
        public static bool SAVE_SYS_PGM_MON(bool doExecute)
        {
            ...
            try
            {
                ...
                oraDB.Parameter_Values[0] = ClassLib.ComVar.This_User;
                oraDB.Parameter_Values[1] = ClassLib.ComVar.This_Computer;
                oraDB.Parameter_Values[2] = ClassLib.ComVar.This_PGM;
                oraDB.Parameter_Values[3] = ClassLib.ComVar.This_Win_ID;
                oraDB.Parameter_Values[4] = ClassLib.ComVar.This_Action;
                oraDB.Parameter_Values[5] = ClassLib.ComVar.This_Packages;
                oraDB.Parameter_Values[6] = ClassLib.ComVar.This_REF2;
                oraDB.Parameter_Values[7] = ClassLib.ComVar.This_REF3;

...
namespace Smart_FTY
{
    public partial class FORM_SMT_B_PROD_MONTHLY : SampleFrm1
    {
        public FORM_SMT_B_PROD_MONTHLY()
        {
            InitializeComponent();
           // formName = "FORM_SMT_B_PROD_MONTHLY";
            this.Name = "FORM_SMT_B_PROD_MONTHLY";
            this.Text = "FORM_SMT_B_PROD_MONTHLY";
        }
        ...
        public DataTable SMT_B_PRODUCTION_MONTHLY(string V_P_MONTH, string V_P_PROCESS)
        {
            COM.OraDB MyOraDB = new COM.OraDB();
            DataSet ds_ret;
            try
            {
                string process_name = "MES.PKG_SMT_B_PRODUCTION.SMT_B_PRODUCTION_MONTHLY";
        ...
        private void Search_Data()
        {
            ...
            DataTable dt = SMT_B_PRODUCTION_MONTHLY(sDate, _sProcess);
        ...
        private void FORM_SMT_B_PROD_MONTHLY_VisibleChanged(object sender, EventArgs e)
        {

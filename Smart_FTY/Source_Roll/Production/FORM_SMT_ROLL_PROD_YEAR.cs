...
namespace Smart_FTY
{
    public partial class FORM_SMT_ROLL_PROD_YEAR : SampleFrm1
    {
        ...
        public DataTable SEL_OS_PROD_YEAR(string ARG_QTYPE, string ARG_YMD, string ARG_OP)
        {
            ...
            try
            {
                string process_name = "MES.PKG_SMT_ROLL.SP_ROLL_PROD_YEAR_V2";
        ...
        private void BindingData(string arg_op)
        {
            ...
            dtsource = SEL_OS_PROD_YEAR("Q", uc_year.GetValue().ToString(), arg_op);
        ...
        {
            DataTable dt = null;
            dt = SEL_OS_PROD_YEAR("C", uc_year.GetValue().ToString(), arg_op);

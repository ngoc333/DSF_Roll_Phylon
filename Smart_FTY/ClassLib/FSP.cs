...
//		}
        ...
        public void Update_Col(int arg_col)
        {
            try
            {
                if (this[arg_col, 0] == null)
                {
                    this[arg_col, 0] = "U";
                }

                if (this[arg_col, 0].ToString() != "I")
                {
                    this[arg_col, 0] = "U";
                }
            ...
            {
                MessageBox.Show(ex.Message.ToString(), "Update_Col", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
		...
		public string Change_RealValue(string arg_data)
		{
			...
			switch(arg_data)
			{
                ...
                case "@Area_CD":
                    ...
                    return_value = "'" + ComVar.This_Area_CD + "'";

                    break;

                case "@gen":

                    return_value = "'" + ComVar.This_Gen + "'";
